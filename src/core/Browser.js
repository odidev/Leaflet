...
export var _nativeTouchEvents = 'ontouchstart' in window || window.TouchEvent;
...
export var touch = !window.L_NO_TOUCH &&
		(_nativeTouchEvents || msPointer && navigator.msMaxTouchPoints);
